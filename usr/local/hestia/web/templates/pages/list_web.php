								...
								<?php if ($data[$key]["SUSPENDED"] == "no") { ?>
									...
									<?php if (isset($_SESSION["DNS_SYSTEM"]) && !empty($_SESSION["DNS_SYSTEM"])) { ?>
										<li class="units-table-row-action" data-key-action="href">
											...
											>
												<i class="fas fa-network-wired icon-lightblue"></i>
												<span><?= tohtml( _("DNS")) ?></span>
											</a>
										</li>
									<?php } ?>
									<?php if (isset($_SESSION["MAIL_SYSTEM"]) && !empty($_SESSION["MAIL_SYSTEM"])) { ?>
										<li class="units-table-row-action" data-key-action="href">
											<a
												class="units-table-row-action-link"
												href="/list/mail/?<?= tohtml(http_build_query(["domain" => $key, "token" => $_SESSION["token"]])) ?>"
												title="<?= tohtml( _("Mail Accounts")) ?>"
											>
												<i class="fas fa-envelope icon-green"></i>
												<span><?= tohtml( _("Mail")) ?></span>
											</a>
										</li>
									<?php } ?>
									<li class="units-table-row-action" data-key-action="href">
